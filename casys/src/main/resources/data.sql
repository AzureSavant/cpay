...
DROP TABLE IF EXISTS CASYS_SHOP_CLIENT;
...
CREATE TABLE CASYS_SHOP_CLIENT(
  ID INT AUTO_INCREMENT,
  SHOP_LINK VARCHAR (250) PRIMARY KEY NOT NULL,
  SHOP_LINK_REF VARCHAR (250)
);

INSERT INTO CASYS_SHOP_CLIENT (SHOP_LINK,SHOP_LINK_REF) VALUES (
  'http://localhost:8080/shop/','http://localhost:8080/shop/casys/transactionRequest/'
);
